    ...
    <>
      ...
      {navigationOpen && (
        <>
          {/* Overlay */}
          <div
            className="xl:hidden fixed inset-0 bg-black/40 z-[90]"
            onClick={closeMobileMenu}
          />

          {/* Menu */}
          <div className="xl:hidden fixed inset-0 z-[100] bg-white dark:bg-gray-900 overflow-y-auto">
            <nav className="flex flex-col gap-2 pt-24 px-4 pb-6">
