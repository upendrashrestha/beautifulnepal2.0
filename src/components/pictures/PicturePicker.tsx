...
export default function PicturePicker({ label, value, onChange }: Props) {
    ...
    const selectFromGallery = (pic: Picture) => {
        ...
        onChange({ url: pic.url, file: null });
    };
        ...
        <div className="space-y-2">
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className="px-3 py-1 border rounded hover:cursor-pointer bg-gray-200 hover:bg-gray-400"
                >
                    Upload
                </button>
                ...
                {preview && (
                    <button
                        type="button"
                        onClick={clearImage}
                        className="inline-flex items-center gap-1 px-3 py-1 text-sm text-red-500 hover:bg-red-50 rounded hover:cursor-pointer transition"
                    >
                        <FaTrash />
                        <span>Remove</span>
                    </button>
